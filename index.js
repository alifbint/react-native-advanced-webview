...
class AdvancedWebView extends React.Component {
    ...
    static propTypes = {
        ...
        */
        ...
        /*
        *Custom attribute used on Android only,
        * Provides support for the browse button to enable download files
        */
    ...
    render() {
        ...
        const webView =
            <NativeWebView
                ...
                enabledDownloadAndroid={this.props.enabledDownloadAndroid}
                {...nativeConfig.props}
            />;
    ...
    */
    ...
    getWebViewHandle = () => {
        return ReactNative.findNodeHandle(this.refs[ADVANCED_WEBVIEW_REF]);
    };
...
const RCTWebView = requireNativeComponent('AdvancedWebView', AdvancedWebView, AdvancedWebView.extraNativeComponentConfig);
